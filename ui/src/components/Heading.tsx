      ...
      <div className="flex items-center justify-between gap-3">
        {editable ? (
          <input
            ...
            // Inline `font-size: 16px` to defeat iOS auto-zoom — Tailwind's
            // text-[16px] was getting overridden somewhere in practice.
            style={{ fontSize: 16 }}
            className="bg-transparent border-0 border-b border-dashed border-[var(--border-subtle)] hover:border-[var(--border-strong)] focus:border-[var(--accent)] focus:border-solid focus:outline-none font-semibold flex-1 min-w-0 transition-colors placeholder:text-[var(--text-tertiary)] placeholder:font-normal placeholder:italic"
          />
        ) : (
